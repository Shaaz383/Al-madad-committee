...
const EditProfileModal = ({ name, email, mobileNumber, onSave, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-whiteColor p-6 rounded-lg shadow-md w-11/12 sm:w-1/3">
        <h3 className="text-xl font-semibold text-center mb-4 text-primaryGreen">Edit Profile</h3>

        <div className="mb-4">
          <label htmlFor="name" className="text-sm text-primaryGreen">
            Your Name
          </label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label htmlFor="email" className="text-sm text-primaryGreen">
            Your Email
          </label>
          <input
            type="email"
        ...
        <div className="mb-4">
          <label htmlFor="mobile" className="text-sm text-primaryGreen">
            Your Mobile Number
          </label>
          <input
            type="text"
        ...
        <div className="flex justify-between">
          ...
          <button
            className="px-4 py-2 bg-primaryGreen text-white rounded-md"
            onClick={handleSave}
          >
            Save
          </button>
